...
// import Navbar from '../components/Navbar';// fijarese que hacer con esto

// export default function EventsCategoryScreen({ route, navigation }) {
...
//         return;
//       }
// //cambiar link de ngrok
//       const response = await axios.get(`https://open-moderately-silkworm.ngrok-free.app/api/event?category=${categoryId}`, {
//           headers: {
...
//                 navigation.navigate(isPastEvent ? 'DetalleEvents' : 'DetalleEvents', { eventId: item.id });
//               }}
//             />
//           </View>
//         )}
